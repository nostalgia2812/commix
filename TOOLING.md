...
- **Full Documentation:** [TOOLS_INDEX.md](https://github.com/nostalgia2812/.github/blob/claude/tooling-filing-system-uG7Gs/TOOLS_INDEX.md#commix)
...
Results are available in the [GitHub Security tab](https://github.com/nostalgia2812/commix/security/code-scanning).
